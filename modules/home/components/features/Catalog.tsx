...
export default async function Catalog() {
  ...
  return (
    <section className="md:py-24 md:max-w-7xl md:mx-auto md:px-8 overflow-hidden" id="catalog">
      <div className="h-[100dvh] md:h-auto overflow-y-auto md:overflow-visible snap-y snap-mandatory no-scrollbar flex flex-col md:grid md:grid-cols-2 md:gap-12 overscroll-behavior-y-contain touch-pan-y">
        
        {/* Header como parte del snap-scroll en móvil */}
        <div className="snap-start snap-always w-full h-[100dvh] md:h-auto flex flex-col justify-center px-4 md:px-0 md:col-span-2 md:block md:mb-16">
        ...
        {products.map((product) => (
          <div key={product.id} className="snap-start snap-always w-full h-[100dvh] md:h-auto flex-shrink-0">
            <ProductCard 
              product={product} 
