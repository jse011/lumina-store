    ...
    try {
      ...
      if (loggedUser && loggedUser.email) {
        ...
        if (code) {
          ...
          // Si no hay código, verificar si ya está registrado
          const isRegistered = await codeRepository.isUserRegistered(loggedUser.uid);
          if (!isRegistered) {
    ...
    <>
      <CodeErrorDialog
        ...
        title={
          ...
          errorType === 'not_registered' ? "Usuario no registrado" :
          undefined
        }
        description={
          ...
          errorType === 'not_registered' ? "No hemos encontrado una cuenta vinculada a este correo. Por favor, valida tu código primero." :
          undefined
        }
      />
